...
const buttonVariants = {
  ...
  visible: { opacity: 1, x: 0, scale: 1, transition: { duration: 0.55, ease: 'easeOut' as const } },
};
  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.12, boxShadow: '0 8px 28px rgba(27,94,32,0.55)' }}
        whileTap={{ scale: 0.95 }}
        aria-label="Llamar"
        title="Llamar ahora"
        style={{
      ...
      <motion.a
        ...
        variants={buttonVariants}
        whileHover={{ scale: 1.1, boxShadow: '0 8px 32px rgba(37,211,102,0.6)' }}
        whileTap={{ scale: 0.95 }}
        aria-label="WhatsApp"
